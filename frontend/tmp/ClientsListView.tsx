...
const contactsData: Contact[] = [
    { id: 1, name: 'ישראל ישראלי', role: 'סמנכ"ל משאבי אנוש', clientName: 'גטר גרופ', clientLogo: 'https://logo.clearbit.com/getter.co.il', phone: '050-1112222', email: 'israel@getter.co.il', lastContact: 'לפני יומיים', avatar: 'יי', pipelineId: 'sales', stageId: 'negotiation' },
    { id: 2, name: 'דנה כהן', role: 'מנהלת גיוס', clientName: 'נעמן גרופ', clientLogo: 'https://logo.clearbit.com/naaman-vardinon.co.il', phone: '052-3334444', email: 'dana@naaman.co.il', lastContact: 'אתמול', avatar: 'דכ', pipelineId: 'sales', stageId: 'proposal' },
    { id: 3, name: 'אביב לוי', role: 'מנהל תפעול', clientName: 'שטראוס מים', clientLogo: 'https://logo.clearbit.com/strauss-water.com', phone: '053-5556666', email: 'aviv@strauss.com', lastContact: 'לפני שבוע', avatar: 'אל', pipelineId: 'retention', stageId: 'active' },
    { id: 4, name: 'יעל שחר', role: 'רכזת גיוס', clientName: 'FedEx', clientLogo: 'https://logo.clearbit.com/fedex.com', phone: '054-7778888', email: 'yael@fedex.co.il', lastContact: 'לפני חודש', avatar: 'יש' },
...
const ClientsListView: React.FC<{ openMessageModal: (config: MessageModalConfig) => void }> = ({ openMessageModal }) => {
    ...
    const handleStageChange = (clientId: number, newStage: string) => {
