...
import { BuildingOffice2Icon, BriefcaseIcon, UserGroupIcon, TagIcon, SquaresPlusIcon, GlobeAmericasIcon, SparklesIcon, ShieldCheckIcon, ListBulletIcon, DocumentTextIcon, ChatBubbleBottomCenterTextIcon, InformationCircleIcon, BoltIcon, ClipboardDocumentListIcon } from './Icons';
...
const AdminLayout: React.FC = () => {
    ...
    const navItems = [
        ...
        { to: '/admin/logs', label: 'לוגים', icon: <ClipboardDocumentListIcon className="w-5 h-5" /> },
