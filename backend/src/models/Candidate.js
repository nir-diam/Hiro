...
const Candidate = sequelize.define(
  'Candidate',
  {
    ...
    recruitmentSourceId: { type: DataTypes.UUID, allowNull: true },
    recruitmentSourceCreatedAt: { type: DataTypes.DATE, allowNull: true },
    recruitmentSourceUpdatedAt: { type: DataTypes.DATE, allowNull: true },
