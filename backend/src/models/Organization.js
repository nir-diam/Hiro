...
const Organization = sequelize.define(
  'Organization',
  {
    ...
    subField: { type: DataTypes.ARRAY(DataTypes.STRING), defaultValue: [] },
    ...
    businessModel: { type: DataTypes.ARRAY(DataTypes.STRING), defaultValue: [] },
    productType: { type: DataTypes.ARRAY(DataTypes.STRING), defaultValue: [] },
